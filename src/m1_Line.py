...
class Line(object):
    ...
    def line_plus(self, other_line):
        ...
        #        They include the Example in the above doc-string.
        # ---------------------------------------------------------------------
        start_n = self.start.plus(other_line.start)
        end_n = self.end.plus(other_line.end)
        return Line(start_n, end_n)
    ...
    def line_minus(self, other_line):
        ...
        #        They include the Example in the above doc-string.
        # ---------------------------------------------------------------------
        start_n = self.start.minus(other_line.start)
        end_n = self.end.minus(other_line.end)
        return Line(start_n, end_n)
